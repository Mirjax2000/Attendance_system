...
class UserViewsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(
            ...
            email="user1@seznam.cz", first_name="User", last_name="One"
        )
        
        self.user2 = User.objects.create_user(
            username="user2", password="pass12345",
            email="user2@seznam.cz", first_name="User", last_name="Two"
        )
    ...
    def test_user_list_view(self):
        ...
        self.assertTemplateUsed(
            response, 'accounts/user_list_detail.html'
        )
    ...
    def test_user_detail_view_valid(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, 'accounts/user_detail.html'
        )
    ...
    def test_user_update_view_invalid_post(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, 'registration/user_update.html'
        )
    ...
    def test_user_delete_view_confirmation(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, 'registration/delete_user.html'
        )
        self.assertEqual(response.context.get('user'), self.user2)
        self.assertContains(response, self.user2.username)
...
class SignUpViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.existing_user = User.objects.create_user(
            username="existing", password="passwd123",
    ...
    def test_signup_view_duplicate_email(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, 'registration/signup.html'
        )
        response = self.client.post(url, data)
        form = response.context.get("form")
        self.assertTrue(form.is_bound)
        self.assertIn("Tento e-mail je již používán. Zvolte jiný.",
...
class CustomLoginViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="testuser", password="heslotajne123",
    ...
    def test_custom_login_view_invalid_credentials(self):
        ...
        self.assertTrue(form.errors)
        self.assertIn(
            'Nepodařilo se přihlásit', str(form.non_field_errors())
        )
