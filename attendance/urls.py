...
from app_dashboard.views import (
    ...
    SendMailView,
    MailTemplatePartialView,
    LoadMailTemplateContentView,
    UpdateDepView,
)
...
app_dashboard_urls: list = [
    ...
    path(
        "dashboard/mail-template-partial/",
        MailTemplatePartialView.as_view(),
        name="mail_template_partial",
    ),
    path(
        "dashboard/ajax/load-mail-template-content/",
